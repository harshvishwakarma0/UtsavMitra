...
async function run() {
  ...
  for (const [path, name] of routes) {
    ...
    try {
      await page.goto("http://localhost:5173" + path, { waitUntil: "networkidle", timeout: 12000 });
  ...
  await page.goto("http://localhost:5173/event/test-id", { waitUntil: "networkidle", timeout: 12000 });
  ...
  await m2.goto("http://localhost:5173/event/test-id", { waitUntil: "networkidle", timeout: 12000 });
  ...
  await page.goto("http://localhost:5173/event/test-id/members", { waitUntil: "networkidle", timeout: 12000 });
  await page.waitForTimeout(500);
